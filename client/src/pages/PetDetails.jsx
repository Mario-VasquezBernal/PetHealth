...
const PetDetails = () => {
  ...
  // ✅ FUNCIÓN MEJORADA: Recargar todos los datos sin caché
  const reloadAllData = async () => {
    try {
      setRefreshing(true);
      
      // ✅ Forzar recarga sin caché usando el parámetro skipCache
      const freshPetData = await getPetById(id, true);
      setPet(freshPetData); // Actualizar estado con datos frescos
      
      await loadMedicalStats(); // Recargar estadísticas
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  onClick={() => {
                    ...
                    reloadAllData(); // ✅ Recargar al cambiar a resumen
                  }}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
